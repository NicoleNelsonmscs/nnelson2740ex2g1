...
public class Main {
    public static void main(String[] args) {
       ...
       obj1 = new Ex2GSample(0, 2, 3.0, 4.0, "Aaaa", "Bbbb");
        if (obj1.test1() == false)
       ...
       obj1.setI1(10);
        ...
        obj1 = new Ex2GSample(1, 1, 3.0, 4.0, "Aaaa", "Bbbb");
        if (obj1.test2() == false)
       ...
       obj1.setI1(3);
        ...
        obj1 = new Ex2GSample(1, 2, 3.0, 4.0, "Aaaa", "Bbbb");
        ...
        obj1 = new Ex2GSample(1, 2, 0, 7.50, "Aaaa", "Bbbb");
        if (obj1.test4() == -1)
